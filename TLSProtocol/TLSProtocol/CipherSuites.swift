...
public struct CipherSuite {
    ...
    public static let TLS_AES_128_GCM_SHA256              = CipherSuite(0x13, 0x01)
    public static let TLS_AES_256_GCM_SHA384              = CipherSuite(0x13, 0x02)
    public static let TLS_CHACHA20_POLY1305_SHA256        = CipherSuite(0x13, 0x03)
    public static let TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384 = CipherSuite(0xc0, 0x2c)
    public static let TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256 = CipherSuite(0xc0, 0x2b)
    public static let TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384 = CipherSuite(0xc0, 0x24)
    public static let TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256 = CipherSuite(0xc0, 0x23)
    public static let TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA = CipherSuite(0xc0, 0x0a)
    public static let TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA = CipherSuite(0xc0, 0x09)
    public static let TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256 = CipherSuite(0xcc, 0xa9)
    public static let TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 = CipherSuite(0xc0, 0x30)
    public static let TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256 = CipherSuite(0xc0, 0x2f)
    public static let TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384 = CipherSuite(0xc0, 0x28)
    public static let TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256 = CipherSuite(0xc0, 0x27)
    public static let TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA = CipherSuite(0xc0, 0x14)
    public static let TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA = CipherSuite(0xc0, 0x13)
    public static let TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256 = CipherSuite(0xcc, 0xa8)
    public static let TLS_RSA_WITH_AES_256_GCM_SHA384  = CipherSuite(0x00, 0x9d)
    public static let TLS_RSA_WITH_AES_128_GCM_SHA256  = CipherSuite(0x00, 0x9c)
    public static let TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA  = CipherSuite(0xc0, 0x08)
    public static let TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA  = CipherSuite(0xc0, 0x12)
}
